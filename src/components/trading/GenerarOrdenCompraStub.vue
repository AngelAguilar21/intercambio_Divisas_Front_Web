<template>
  <q-card flat bordered class="q-pa-md xc-stub">
    <div class="text-subtitle1 text-weight-medium q-mb-sm">Generar orden de compra</div>
    <q-separator class="q-mb-md" />
    <div class="xc-stub-body flex flex-center column q-py-md">
      <q-icon name="shopping_cart" size="2rem" class="xc-stub-icon q-mb-sm" />
      <div class="text-body2 text-weight-medium">Componente US-013 — pendiente</div>
      <div class="text-caption q-mt-xs xc-stub-par">
